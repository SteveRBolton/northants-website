...
export interface ArticleNode_Full_body_embeds_paragraph_HighlightParagraph_content {
  __typename: "FormattedField";
  value: string;
}

export interface ArticleNode_Full_body_embeds_paragraph_HighlightParagraph {
  __typename: "HighlightParagraph";
  title: string;
  content: ArticleNode_Full_body_embeds_paragraph_HighlightParagraph_content | null;
  isWarning: boolean | null;
}

export type ArticleNode_Full_body_embeds_paragraph = ArticleNode_Full_body_embeds_paragraph_AccordionItemParagraph | ArticleNode_Full_body_embeds_paragraph_CallToActionParagraph | ArticleNode_Full_body_embeds_paragraph_BlockQuoteParagraph | ArticleNode_Full_body_embeds_paragraph_AccordionParagraph | ArticleNode_Full_body_embeds_paragraph_FileDownloadParagraph | ArticleNode_Full_body_embeds_paragraph_HighlightParagraph;
